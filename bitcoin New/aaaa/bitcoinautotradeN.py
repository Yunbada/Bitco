...
accessKey="FBkY10ExfWsLyaaTe68YII9xAhctCCSx9AdpuxOy"
secretKey="XlmVQxrkYzKtxxNtxC3jOCFCu0p7gn4iqx1btgTO"
coinNow="KRW-BTC"

def change_target_coin():
    """코인 변환"""
    coinNow = telegramMessage.message().whatcoin
...
def get_ma15(ticker):
    ...
    ma15 = df['close'].rolling(8).mean().iloc[-1]
    return ma15
        ...
        try:
            ...
            if start_time < now < end_time - datetime.timedelta(seconds=10):
                ...
                if target_price < current_price and ma15 < current_price:
                    krw = float(upbit.get_balance(coinNow))
            ...
            elif messageId==message.changecoin:
                message.send_message("코인을 바꿉니다")
                change_target_coin()
                message.send_message("바꿈")
