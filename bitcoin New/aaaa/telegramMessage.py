...
class message:
    ...
    def __init__(self):
        ...
        self.bestKUpdate=4
        self.changecoin = 5
        self.whatcoin = 'KWR-BTC'

    def SetInfo(self):
        
        self.token = "5179264157:AAFs3zmniTO0dAro1lsYlIiAdhvgIr_XnPE"
        self.my_chat_id="5228436315"
    ...
    def CheckMessageInLoop(self):
        ...
        if text !="null":
            ...
            if "코인" in text:
                self.msgSet.add(msg_id)
                self.chageplag = True
                return self.changecoin
            if self.chageplag == True:
                self.whatcoin = text
                self.msgSet.add(msg_id)
                return self.whatcoin
        return 0
